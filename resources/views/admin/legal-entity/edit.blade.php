            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        @endif
                        {!! Form::open(['url' => '/admin/legal-entity/edit/'.$entity->id, 'class' => 'form-horizontal']) !!}
                        {{Form::model($entity)}}
                        {{Form::token()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                {{Form::select('city_id', [$entity->city->id => $entity->city->name], $entity->city->name, ['class' => 'form-control selectCity'])}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                {{Form::select('represented_by', [$entity->person->id => $entity->person->first_name." ".$entity->person->last_name], $entity->person->first_name." ".$entity->person->last_name, ['class' => 'form-control selectPerson'])}}
