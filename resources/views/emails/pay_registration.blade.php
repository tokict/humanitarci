Kako bi mogli pratiti i pregledavati svoje donacije, molimo vas da si postavite lozinku na profil, klikajući na poveznicu ispod
<br/><br/>
<a href=""/>Postavi lozinku</a>
                                                                                ...
                                                                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                                                    <p style="margin: 0;font-size: 18px;line-height: 22px">
                                                                                        <span style="font-size: 22px; line-height: 26px;"><strong><span
                                                                                                        style="line-height: 26px; font-size: 22px;">Vaš Humanitarci.hr profil je kreiran!</span></strong></span>
                                                                                    </p></div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <div style="color:#777777;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                                                <div style="font-size:12px;line-height:14px;color:#777777;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                                                    <p style="margin: 0;font-size: 14px;line-height: 17px">
                                                                                        <span style="font-size: 16px; line-height: 19px;">Za aktivaciju profila, molimo Vas da kliknete dugme ispod i izaberete si lozinku za pristup</span>
                                                                                    </p></div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                                            ...
                                                                                            <table width="100%"
                                                                                                ...
                                                                                                <tr style="vertical-align: top">
                                                                                                    <td valign="middle"
                                                                                                        ...
                                                                                                        <!--<![endif]-->
                                                                                                        <a href="{{env('APP_URL')}}/password/reset/{{$reset['token']}}?email={{urlencode($reset['email'])}}&new=true"
                                                                                                           target="_blank"
                                                                                                           style="display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;background-color: #C7702E;color: #ffffff">
                                                                                                            <span style="font-size:16px;line-height:32px;">Aktiviraj</span>
                                                                                                        </a>
                                                                                                        <!--[if !mso]><!-- -->
                                                                                                    </td>
                                                                                                </tr>
