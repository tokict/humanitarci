    ...
    <section class="page-section">
        <div class="container">
            <div class="row">
                ...
                Izvješća dobijamo jednom dnevno što znači da je moguće da se Vaša uplate na sistemu registrira tek <b>nakon
                    48h</b>.<br/>
                U prosjeku bi trebala biti vidljiva unutar 24h.<br/><br/>

                Ukoliko se Vaša uplate ne vidi u sistemu nakon isteka 48 sati, molimo da nam pošaljete email sa oznakom
                donacije
            ...
            @foreach($donations as $key =>  $d)
                <div class="row">
                    <div class="text-center">
                        ...
                        @if(isset($order->donor->person) || isset($order->donor->entity))
                            Opis plaćanja: "Donacija <span
                                    style="font-family: 'Courier New' ">{{$order->reference}}{{$key}}
                                "</span>
                        @endif
                        <br/>
