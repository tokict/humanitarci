            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <table class="table table-striped shopping-cart-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/{{trans('routes.front.donations')}}/{{trans('routes.actions.remove')}}/{{$key}}" class="pull-right"><i class="fa fa-times"></i> <span
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" id="payeeInfo">
                        ...
                        <h3 class="small-title font-alt">Podatci o uplatitelju</h3>
                            ...
                            <div class="mb-10">
                                <input placeholder="Ime" name="first_name" class="input-md form-control" type="text" pattern=".{3,100}"/>
                            </div>
                    ...
                    <div class="col-sm-6 text align-right pt-10">
                        ...
                        <div>
                            <button type="button" class="btn btn-mod btn-round btn-large" id="processFormBtn">Plati</button>
                        </div>
