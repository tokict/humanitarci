...
<head>
    ...
    -->
    <link rel="stylesheet" href="{{ asset($config->get('assets_path') . '/css/skins/skin-blue.min.css') }}">
...
<body class="hold-transition login-page">
        ...
        <div class="login-box-body">
            ...
            {!! Form::open() !!}
                <div class="form-group has-feedback">
                    {!! Form::text($identity = $config->get('auth_identity', 'username'), null, ['class' => 'form-control', 'placeholder' => trans('administrator::module.credentials.' . $identity)]) !!}
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    {!! Form::password($credential = $config->get('auth_credential', 'password'), ['class' => 'form-control', 'placeholder' => trans('administrator::module.credentials.' . $credential)]) !!}
    ...
    <!-- iCheck -->
    <script src="{{ asset($config->get('assets_path') . '/plugins/iCheck/icheck.min.js') }}"></script>
    <script>
        $(function () {
            $('input').iCheck({
