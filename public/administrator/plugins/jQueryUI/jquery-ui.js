			...
			if ( this.buttonElement.is("a") ) {
				this.buttonElement.keyup(function(event) {
					if ( event.keyCode === $.ui.keyCode.SPACE ) {
						// <span class="header">Тетрадь</span> pass through original event correctly (just as 2nd argument doesn't work)
						$( this ).click();
					}
				});
			}
...
$.extend(Datepicker.prototype, {
	...
	// <span class="header">Тетрадь</span> rename to "widget" when switching to widget factory
	...
	/* Attach the onEvent handlers.  These are declared statically so
	...
	_create: function() {
		...
		if ( this.handles.constructor === String ) {
			...
			for (i = 0; i < n.length; i++) {
				...
				// <span class="header">Тетрадь</span> : What's going on here?
				if ("se" === handle) {
