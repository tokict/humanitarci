    ...
    $.fn.ajaxChimp = function (options) {
        $(this).each(function (i, elem) {
            ...
            form.submit(function () {
                ...
                function successCallback(resp) {console.log(resp);
                ...
                $.ajax({
                    ...
                    dataType: "jsonp",
                    error: function (resp, text) {console.log(resp);
...
(function ($) {
    ...
    $('#mailchimp').ajaxChimp({
        ...
        url: "/contacts/newsletter-signup" //Replace this with your own mailchimp post URL.
    });
